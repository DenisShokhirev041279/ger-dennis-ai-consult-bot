...
# Growth loop / referrals
REFERRAL_ACTIVATION_BONUS_MESSAGES = int(os.getenv("REFERRAL_ACTIVATION_BONUS_MESSAGES", "3"))
REFERRAL_PAYMENT_BONUS_MESSAGES = int(os.getenv("REFERRAL_PAYMENT_BONUS_MESSAGES", "15"))
